...
export const IMAGE_MODELS: ImageModel[] = [
  ...
  },
  {
    ...
    brief:
      'Black Forest Labs FLUX1.1 Pro via Replicate (BFL direct is dropped — Replicate is the Flux route). Fast, photoreal, huge style range at a flat ~$0.05/image. The default workhorse for rich illustrated / photoreal looks. Weak at in-image text and has no real edit path — route text/edits to gpt-image-1.',
    sourceRefreshedAt: REFRESHED,
  },
  {
    id: 'flux-dev',
